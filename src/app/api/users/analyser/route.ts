...
import { file } from '@/app/utils/file'; // Your resume text or buffer
...
`;
  ...
  try {
    const resumeText = file; // Assuming this is a string with resume content
    ...
    try {
      ...
      vectorStore = await HNSWLib.fromDocuments(
        [new Document({ pageContent: resumeText })],
        embeddings
      );
      await vectorStore.save(vectorStorePath); // Save to disk
    }
